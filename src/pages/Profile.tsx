...
function isRequired(fieldKey: string, role: string | null): boolean {
  ...
  return (
    requiredFieldKeys.common.includes(fieldKey) ||
    (requiredFieldKeys[role] ?? []).includes(fieldKey)
  );
}
...
export default function Profile() {
  ...
  const showSkillsSection =
    role === "service_provider" || role === "youth_association";
  const showQualificationsSection =
    role === "service_provider" || role === "youth_association";
          ...
          <>
                ...
                <CardContent className="p-4 flex items-start gap-3">
                  ...
                  <div className="space-y-1 text-sm">
                    <p className="font-semibold">
                      لديك تعديلات قيد مراجعة الإدارة
                    </p>
                    <p className="text-muted-foreground">
                      الحقول المطلوب تعديلها:{" "}
                      {Object.keys(
                        (pendingEdit as any).requested_changes || {},
                      ).join("، ") || "—"}
                  ...
                  <div className="flex flex-wrap gap-2">
                    {requiredFields.map((f) => {
                      ...
                      return (
                        <span
                          key={f.key}
                          className={`inline-flex items-center gap-1 text-xs px-2 py-1 rounded-full ${isFilled ? "bg-success/10 text-success" : "bg-muted text-muted-foreground"}`}
                        >
                          {isFilled ? (
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div className="space-y-2">
                    ...
                    >
                      الاسم الكامل{" "}
                      <RequiredMark fieldKey="full_name" role={role} />
                    </Label>
                    <Input
                      id="fullName"
                      value={fullName}
                      onChange={(e) => setFullName(e.target.value)}
                      className={`h-11 ${isRequired("full_name", role) && !fullName ? "border-warning" : ""}`}
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="phone" className="flex items-center gap-1">
                      ...
                      <RequiredMark fieldKey="phone" role={role} />
                    </Label>
                    <Input
                      id="phone"
                      value={phone}
                      ...
                      dir="ltr"
                      placeholder="+966..."
                      className={`h-11 ${isRequired("phone", role) && !phone ? "border-warning" : ""}`}
                    />
                  </div>
                  ...
                  {(role === "youth_association" || showOrgNameForDonor) && (
                    <div className="space-y-2">
                      ...
                      >
                        ...
                        {isDonor ? "اسم الشركة / المنظمة" : "اسم المنظمة"}{" "}
                        {!isDonor && (
                          <RequiredMark
                      ...
                      <Input
                        ...
                        placeholder={isDonor ? "اختياري" : ""}
                        className={`h-11 ${isRequired("organization_name", role) && !organizationName ? "border-warning" : ""}`}
                      />
                    </div>
                  )}
                  ...
                  {role === "youth_association" && (
                    <div className="space-y-2">
                      ...
                      >
                        رقم الترخيص{" "}
                        <RequiredMark fieldKey="license_number" role={role} />
                      </Label>
                      <Input
                        id="licenseNumber"
                        value={licenseNumber}
                        ...
                        dir="ltr"
                        className={`h-11 ${isRequired("license_number", role) && !licenseNumber ? "border-warning" : ""}`}
                      />
                    </div>
                  )}
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="text-lg flex items-center gap-2">
                    ...
                    {isRequired("bio", role) && (
                      <RequiredMark fieldKey="bio" role={role} />
                    )}
                  </CardTitle>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="space-y-2">
                    <Label htmlFor="bio">
                      {isDonor
                        ? "اكتب نبذة عن جهتك المانحة وأهدافك في الدعم"
                        : "اكتب نبذة عنك أو عن مؤسستك"}
                    </Label>
                    <Textarea
                      id="bio"
                      value={bio}
                      ...
                      rows={8}
                      className={`resize-none ${isRequired("bio", role) && !bio ? "border-warning" : ""}`}
                    />
                  </div>
                </CardContent>
              </Card>
            ...
            {isDonor && (
              <Card>
                <CardHeader>
                  <CardTitle className="text-lg flex items-center gap-2">
                    <Building className="h-5 w-5 text-primary" /> شعار الجهة
                    المانحة
                  </CardTitle>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="flex flex-col sm:flex-row items-center gap-6">
                    ...
                    >
                      ...
                      <p className="text-sm font-medium">
                        {companyLogoUrl
                          ? "تغيير الشعار"
                          : "رفع شعار الجهة المانحة"}
                      </p>
                      <p className="text-xs text-muted-foreground mt-1">
                        اسحب الصورة وأفلتها هنا أو اضغط لاختيار ملف
                      </p>
                      <p className="text-xs text-muted-foreground mt-0.5">
                        الأبعاد المُوصى بها: 300×300 بكسل • الحد الأقصى: 2 MB
                      </p>
                      <input
                        ref={logoInputRef}
                        type="file"
            ...
            {showBankSection && (
              <Card>
                <CardHeader>
                  <CardTitle className="text-lg flex items-center gap-2">
                    <Landmark className="h-5 w-5 text-primary" /> البيانات
                    البنكية
                  </CardTitle>
                </CardHeader>
                <CardContent className="grid sm:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    >
                      اسم البنك{" "}
                      <RequiredMark fieldKey="bank_name" role={role} />
                    </Label>
                    <Input
                      id="bankName"
                      value={bankName}
                      ...
                      className={`h-11 ${!bankName ? "border-warning" : ""}`}
                    />
                  </div>
                  <div className="space-y-2">
                    <Label
                    ...
                    <Input
                      ...
                      className={`h-11 ${!bankAccountHolder ? "border-warning" : ""}`}
                    />
                  </div>
                  <div className="space-y-2">
                    <Label
                    ...
                    <Input
                      ...
                      dir="ltr"
                      className={`h-11 ${!bankAccountNumber ? "border-warning" : ""}`}
                    />
                  </div>
                  <div className="space-y-2">
                    <Label
                    ...
                    <Input
                      ...
                      maxLength={24}
                      className={`h-11 ${!bankIban ? "border-warning" : ""}`}
                    />
                    {bankIban &&
                      (!bankIban.startsWith("SA") ||
                        bankIban.length !== 24) && (
                        <p className="text-xs text-destructive">
                          يجب أن يبدأ بـ SA ويتكون من 24 حرف ({bankIban.length}
                          /24)
                        </p>
                      )}
                  </div>
            ...
            {showQualificationsSection && (
              <Card>
                <CardHeader>
                  <CardTitle className="text-lg flex items-center gap-2">
                    <GraduationCap className="h-5 w-5 text-primary" /> المؤهلات
                    والشهادات
                  </CardTitle>
                </CardHeader>
                <CardContent className="space-y-4">
                    ...
                    >
                      <div className="flex-1 space-y-2">
                        <Input
                          ...
                          value={q.title}
                          onChange={(e) =>
                            updateQualification(i, "title", e.target.value)
                          }
                          className="h-9"
                        />
                        <Input
            ...
            {role === "youth_association" && (
              <Card>
                <CardHeader>
                  <CardTitle className="text-lg flex items-center gap-2">
                    <Phone className="h-5 w-5 text-primary" /> بيانات ضابط
                    الاتصال
                  </CardTitle>
                </CardHeader>
                <CardContent className="grid sm:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      className={`h-11 ${isRequired("contact_officer_name", role) && !contactOfficerName ? "border-warning" : ""}`}
                    />
                  </div>
                  <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      رقم ضابط الاتصال{" "}
                      <RequiredMark
                        fieldKey="contact_officer_phone"
                        role={role}
                      />
                    </Label>
                    <Input
                      ...
                      onChange={(e) => setContactOfficerPhone(e.target.value)}
                      dir="ltr"
                      className={`h-11 ${isRequired("contact_officer_phone", role) && !contactOfficerPhone ? "border-warning" : ""}`}
                    />
                  </div>
                  <div className="space-y-2">
