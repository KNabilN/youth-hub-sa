      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              إنشاء وإدارة أكواد الخصم للجمعيات
            </p>
          </div>
        ...
        {!codes?.length ? (
          <EmptyState
            ...
            description="أنشئ أول كود خصم بالضغط على الزر أعلاه"
          />
        ) : (
          <Card>
        ...
        <ConfirmDialog
          ...
          onConfirm={() =>
            deleteId &&
            deleteCode.mutate(deleteId, { onSuccess: () => setDeleteId(null) })
          }
        />
      </div>
    </DashboardLayout>
      ...
      <DialogContent className="sm:max-w-md">
        ...
        <DialogFooter>
          <Button
            onClick={onSubmit}
            disabled={
              loading || !formCode || !formAmount || !formStart || !formEnd
            }
          >
            {submitLabel}
          </Button>
              ...
              <div className="grid grid-cols-2 gap-3 text-sm">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-bold">
                    {code.amount.toLocaleString()} ر.س
                  </span>
                </div>
                <div className="flex items-center gap-2">
                    ...
                    >
                      <div className="flex justify-between">
                        <span className="font-medium">
                          {u.profiles?.organization_name ||
                            u.profiles?.full_name ||
                            "—"}
                        </span>
                        <span className="font-bold text-primary">
                          −{u.discount_amount.toLocaleString()} ر.س
                        </span>
                      </div>
                      <div className="flex justify-between text-xs text-muted-foreground">
                        <span>
                          {u.projects?.title
                            ? `مشروع: ${u.projects.title}`
                            : ""}
                          {u.micro_services?.title
                            ? `خدمة: ${u.micro_services.title}`
                            : ""}
