...
import {
  useAssociationImpactReports,
  useCreateImpactReport,
} from "@/hooks/useAssociationImpactReports";
    ...
    <DashboardLayout>
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          ...
          <Dialog open={open} onOpenChange={setOpen}>
            <DialogTrigger asChild>
              <Button>
                <Plus className="h-4 w-4 me-1" /> رفع تقرير
              </Button>
            </DialogTrigger>
            <DialogContent>
              <DialogHeader>
                <DialogTitle>رفع تقرير أثر جديد</DialogTitle>
              </DialogHeader>
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Select value={donorId} onValueChange={setDonorId}>
                    <SelectTrigger>
                      <SelectValue placeholder="اختر المانح" />
                    </SelectTrigger>
                    <SelectContent>
                      {donors.map((d: any) => (
        ...
        {!reports?.length ? (
          <EmptyState
            icon={BarChart3}
            title="لا توجد تقارير أثر"
            description="ارفع تقارير أثر لتوضيح للمانحين كيف تم استخدام منحهم"
          />
        ) : (
          <Card>
            <CardHeader>
                      ...
                      <TableRow key={r.id}>
                        ...
                        <TableCell>
                          <Button
                            ...
                            size="sm"
                            onClick={() =>
                              handleDownload(r.file_path, r.file_name)
                            }
                          >
