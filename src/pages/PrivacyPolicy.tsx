      ...
      <div className="max-w-3xl mx-auto px-6 py-16 space-y-8">
        ...
        <div className="prose prose-sm max-w-none space-y-6 text-foreground">
          <section className="space-y-3">
            ...
            <p>
              تلتزم منصة الخدمات المشتركة للجمعيات الشبابية ("المنصة") بحماية بياناتك الشخصية وفقاً لنظام حماية البيانات الشخصية (PDPL)
              الصادر بالمرسوم الملكي رقم (م/19) في المملكة العربية السعودية.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <ul className="list-disc pr-6 space-y-1">
              ...
              <li><strong>بيانات الاستخدام:</strong> سجل النشاط، التفضيلات، سجلات الدخول</li>
              <li><strong>الملفات المرفقة:</strong> المستندات والصور المرفوعة للمشاريع والنزاعات</li>
            </ul>
          </section>
          ...
          <section className="space-y-3">
            ...
            <ul className="list-disc pr-6 space-y-1">
              ...
              <li>إدارة العقود والنزاعات بين الأطراف</li>
          ...
          <section className="space-y-3">
            ...
            <ul className="list-disc pr-6 space-y-1">
              ...
              <li><strong>الالتزام القانوني:</strong> للامتثال لأنظمة المملكة العربية السعودية</li>
            </ul>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p>لممارسة أي من هذه الحقوق، يرجى التواصل معنا عبر تذاكر الدعم الفني.</p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p>
              نحتفظ ببياناتك طوال فترة نشاط حسابك وللمدة اللازمة للوفاء بالتزاماتنا القانونية.
              يتم حذف البيانات المالية بعد 7 سنوات وفقاً للمتطلبات التنظيمية.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p>
              لأي استفسارات حول سياسة الخصوصية أو بياناتك الشخصية، يمكنك فتح تذكرة دعم فني من خلال حسابك على المنصة.
            </p>
          </section>
        </div>
      </div>
