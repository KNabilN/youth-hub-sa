...
export default function TimeLogs() {
  ...
  const { data: logs, isLoading } = useAssociationTimeLogs(
    filter,
    projectFilter,
  );
          ...
          <Card>
            <CardContent className="p-4 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold">{pendingHours}</p>
              </div>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="p-4 flex items-center gap-3">
              ...
              <div>
                <p className="text-sm text-muted-foreground">ساعات معتمدة</p>
