    ...
    <DashboardLayout>
      <div className="space-y-6 max-w-3xl">
          ...
          <CardHeader>
            ...
            <div className="flex items-center gap-3 text-sm text-muted-foreground mt-1">
              {project.is_name_visible && project.profiles ? (
                <Link
                  to={`/profile/${project.association_id}`}
                ...
                >
                  ...
                  <span className="font-medium">
                    {project.profiles.organization_name ||
        ...
        {createdBidId ? (
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-lg">تقديم عرض</CardTitle>
            </CardHeader>
            <CardContent>
              {canBid ? (
                <BidForm
                  onSubmit={handleSubmit}
                  isLoading={submitBid.isPending || uploading}
                />
                ...
                <Alert>
                  ...
                  <AlertDescription className="space-y-3">
                    <p>
                      يجب إضافة نموذج عمل واحد على الأقل في معرض الأعمال قبل
                      تقديم العروض.
                    </p>
                    <Button
                      variant="outline"
