...
const escrowStatusLabel: Record<
  string,
  {
    label: string;
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              تتبع حالة الخدمات التي اشتريتها للجمعيات
            </p>
          </div>
        </div>
              ...
              <div className="overflow-x-auto">
                <Table>
                  ...
                  <TableBody>
                    {purchases.map((p: any) => {
                      const escrowSt =
                        escrowStatusLabel[p.status] ?? escrowStatusLabel.held;
                      ...
                      return (
                        <TableRow key={p.id}>
                          ...
                          <TableCell className="text-sm">
                            {p.projects?.profiles?.organization_name ||
