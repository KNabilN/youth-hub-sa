...
const AssociationImpactReports = lazy(
  () => import("./pages/AssociationImpactReports"),
);
...
const AdminDisputeDetail = lazy(
  () => import("./pages/admin/AdminDisputeDetail"),
);
...
const AdminContractDetail = lazy(
  () => import("./pages/admin/AdminContractDetail"),
);
            ...
            <AuthProvider>
              <Suspense fallback={<PageLoader />}>
                <Routes>
                  ...
                  />
                  <Route
                    path="/association-impact"
                    element={
                      <ProtectedRoute>
                        <SuspenseWrap>
                          <AssociationImpactReports />
                        </SuspenseWrap>
                      </ProtectedRoute>
                    }
                  />
