      ...
      },
      {
        onSuccess: async () => {
          await logAudit(
            "micro_services",
            service.id,
            reasonAction === "suspended" ? "suspend" : "reactivate",
    ...
    <>
      <Card className="overflow-hidden">
        {(service.image_url || (service as any).categories?.image_url) && (
          <div className="w-full h-32 overflow-hidden">
            <img
              src={service.image_url || (service as any).categories?.image_url}
              alt={service.title}
        ...
        <CardHeader className="flex flex-row items-start justify-between gap-2 pb-3">
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-1">
              {service.profiles?.organization_name ||
          ...
          <div className="flex gap-2 flex-wrap">
            ...
            {service.approval === "suspended" && (
              <Button
                ...
                onClick={() => openReasonDialog("approved")}
                disabled={update.isPending}
              >
            ...
            <AlertDialog>
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    سيتم نقل "{service.title}" إلى سلة المحذوفات لمدة 30 يوماً.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
      ...
      <Dialog open={reasonDialogOpen} onOpenChange={setReasonDialogOpen}>
        <DialogContent className="sm:max-w-md">
          ...
          <DialogFooter>
            ...
            <Button
              variant={reasonAction === "suspended" ? "destructive" : "default"}
      ...
      <Dialog open={rejectDialogOpen} onOpenChange={setRejectDialogOpen}>
        <DialogContent className="sm:max-w-md">
          ...
          <div className="space-y-3">
            <p className="text-sm text-muted-foreground">
              سيتم رفض خدمة "{service.title}" وإرسال سبب الرفض لمقدم الخدمة.
            </p>
            <div>
