...
export function DonationForm({
  ...
  const selectedAssociation = associations?.find(
    (a) => a.id === selectedAssociationId,
  );
  const selectedProjectId = form.watch("project_id");
  const selectedProject = associationProjects?.find(
  ...
  const projectBudget = selectedProject?.budget
              ...
              <Popover open={assocOpen} onOpenChange={setAssocOpen}>
                <PopoverTrigger asChild>
                  <FormControl>
                    ...
                    >
                      {selectedAssociation
                        ? selectedAssociation.organization_name ||
                          selectedAssociation.full_name
                        : "ابحث واختر الجمعية..."}
                ...
                <Popover open={projectOpen} onOpenChange={setProjectOpen}>
                  ...
                  >
                    <Command>
                      ...
                      <CommandList>
                        <CommandEmpty>
                          لا توجد طلبات مفتوحة لهذه الجمعية
                        </CommandEmpty>
                        <CommandGroup>
            ...
            <div className="grid grid-cols-3 gap-2 text-sm">
              <div className="text-center p-2 rounded bg-background">
                ...
                <div className="font-semibold text-foreground">
                  {formatCurrency(projectBudget)} ر.س
                </div>
              </div>
              <div className="text-center p-2 rounded bg-background">
                <div className="text-muted-foreground text-xs">
                ...
                <div className="font-semibold text-primary">
                  {formatCurrency(grantsAvailable)} ر.س
                </div>
              </div>
              <div className="text-center p-2 rounded bg-background">
                <div className="text-muted-foreground text-xs">
