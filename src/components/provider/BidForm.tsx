...
const bidSchema = z.object({
  ...
  cover_letter: z
    .string()
    .min(10, "خطاب التقديم يجب أن يكون 10 أحرف على الأقل")
    .max(5000),
});
      ...
      >
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Textarea
                  placeholder="اكتب خطاب التقديم الخاص بك..."
                  rows={5}
                  maxLength={5000}
                  {...field}
                />
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            يمكنك إرفاق ملفات داعمة لعرضك (الحد الأقصى 10 ميجابايت للملف)
          </p>
        </div>
        ...
        <Button
          type="submit"
          disabled={isLoading}
          className="w-full bg-gradient-to-l from-primary to-primary/90 hover:from-primary/90 hover:to-primary shadow-sm"
        >
