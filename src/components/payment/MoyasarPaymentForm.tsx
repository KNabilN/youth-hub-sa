...
const SCRIPT_URL = "https://cdn.jsdelivr.net/npm/moyasar-payment-form@2.2.7/dist/moyasar.umd.min.js";
const CSS_URL = "https://cdn.jsdelivr.net/npm/moyasar-payment-form@2.2.7/dist/moyasar.css";
...
export function MoyasarPaymentForm({
  ...
  const addTimer = useCallback((id: number, type: "timeout" | "interval") => {
    cleanupRef.current.push(() => (type === "timeout" ? clearTimeout(id) : clearInterval(id)));
  }, []);
      ...
      <CardContent className="p-4">
        {showError ? (
          ...
          <>
            ...
            <div ref={containerRef} id={uniqueId} style={{ display: formReady ? "block" : "none" }} />
          </>
        )}
      </CardContent>
    </Card>
