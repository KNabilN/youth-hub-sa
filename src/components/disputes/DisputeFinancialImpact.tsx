...
export function DisputeFinancialImpact({
  projectId,
}: DisputeFinancialImpactProps) {
  const { data, isLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      return {
        ...
        failed,
        commission,
        total: frozen + released + refunded + held + failed,
      };
    },
    enabled: !!projectId,
  });
