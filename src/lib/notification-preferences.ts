...
const SERVICE_PROVIDER_GROUPS: NotificationGroup[] = [
  ...
  },
  {
    ...
    types: [
      ...
      {
        key: "escrow_released",
        label: "تحرير ضمان مالي",
        defaultEnabled: true,
      },
      {
        key: "escrow_refunded",
        label: "استرداد ضمان مالي",
        defaultEnabled: true,
      },
      {
        key: "withdrawal_approved",
        label: "الموافقة على طلب سحب",
        defaultEnabled: true,
      },
      {
      ...
      {
        key: "withdrawal_processed",
        label: "تحويل مبلغ السحب",
        defaultEnabled: true,
      },
    ],
  },
  {
    ...
    types: [
      {
        key: "service_approved",
        label: "الموافقة على خدمة",
        defaultEnabled: true,
      },
  ...
  },
  {
    ...
    types: [
      {
        key: "timelog_approved",
        label: "الموافقة على سجل الوقت",
        defaultEnabled: true,
      },
  ...
  },
  {
    ...
    types: [
      {
        key: "deliverable_accepted",
        label: "قبول التسليمات",
        defaultEnabled: true,
      },
      {
        key: "deliverable_revision",
        label: "طلب تعديلات على التسليمات",
        defaultEnabled: true,
      },
    ],
  },
  {
    ...
    types: [
      ...
      {
        key: "inquiry_created",
        label: "استفسار جديد عن خدمة",
        defaultEnabled: true,
      },
      {
        key: "inquiry_message",
        label: "رسالة استفسار عن خدمة",
        defaultEnabled: true,
      },
    ],
  },
...
const YOUTH_ASSOCIATION_GROUPS: NotificationGroup[] = [
  {
    ...
    types: [
      {
        key: "bid_received",
        label: "استلام عرض سعر جديد",
        defaultEnabled: true,
      },
      {
        key: "project_open",
        label: "الموافقة على المشروع",
        defaultEnabled: true,
      },
  ...
  },
  {
    ...
    types: [
      ...
      {
        key: "bank_transfer_approved",
        label: "الموافقة على تحويل بنكي",
        defaultEnabled: true,
      },
      {
        key: "bank_transfer_rejected",
        label: "رفض تحويل بنكي",
        defaultEnabled: true,
      },
  ...
  },
  {
    ...
    types: [
      {
        key: "grant_request_approved",
        label: "الموافقة على طلب منحة",
        defaultEnabled: true,
      },
      {
        key: "grant_request_rejected",
        label: "رفض طلب منحة",
        defaultEnabled: true,
      },
      {
        key: "grant_request_funded",
        label: "تمويل طلب منحة",
        defaultEnabled: true,
      },
    ],
  },
    ...
    types: [
      {
        ...
        label: "تأكيد استلام تبرع",
        defaultEnabled: true,
      },
      {
        key: "project_completed",
        label: "إكمال مشروع مدعوم",
        defaultEnabled: true,
      },
      {
        key: "grant_request_received",
        label: "طلب منحة جديد",
        defaultEnabled: true,
      },
    ],
    ...
    types: [
      {
        ...
        label: "تحويل بنكي جديد بانتظار المراجعة",
        defaultEnabled: true,
      },
      { key: "dispute_opened", label: "شكوى جديدة", defaultEnabled: true },
      {
        key: "contact_message",
        label: "رسالة تواصل جديدة",
        defaultEnabled: true,
      },
      { key: "ticket_reply", label: "رد على تذكرة دعم", defaultEnabled: true },
    ],
  },
];
