...
('hero', '{"badge":"منصة رقمية متوافقة مع رؤية 2030","title":"منصة الخدمات المشتركة","subtitle":"للجمعيات الشبابية","description":"منصة رقمية سعودية تربط الجمعيات الشبابية بمقدمي الخدمات المؤهلين والمانحين لتعزيز التميز المؤسسي والشفافية","cta_text":"ابدأ الآن"}'::jsonb),
